...
// the index of this output in that transaction (indices are simply integers starting from 0), and 
// a digital signature. For the input to be valid, the signature it contains must be a valid signature 
...
// method. To verify a signature, you will use the ​verifySignature()​ method included in the provided 
// file Crypto.java:
